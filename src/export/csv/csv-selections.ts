...
function recursiveKeys(obj: object, path: string, pathMap: Record<string, boolean>): Record<string, boolean> {
...
export const toCSVSelections = (transactions: KoinlyTransaction[]): CSVSelections => {
